...
namespace SaeProject_01.Datasets {
    ...
    public partial class UserDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserRow AddUserRow(string Username, string Passwort) {
            ...
            public string Username {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte Username in Tabelle User ist DBNull.", e);
                    }
                }
                set {
...
namespace SaeProject_01.Datasets.UserDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `User` WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Use" +
                "rname` = ?)) AND ((? = 1 AND `Passwort` IS NULL) OR (`Passwort` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `User` (`Username`, `Passwort`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `User` SET `Username` = ?, `Passwort` = ? WHERE ((`ID` = ?) AND ((? = 1 AN" +
                "D `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Passwort` IS NULL) O" +
                "R (`Passwort` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SaeProject_01.Properties.Settings.Default.mainConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Username, Passwort FROM [User]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO `User` (`Username`, `Passwort`) VALUES (?, ?)";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Passwort", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Passwort", global::System.Data.DataRowVersion.Current, false, null));
        }
        ...
        public virtual int Delete(int Original_ID, string Original_Username, string Original_Passwort) {
        ...
        public virtual int Insert(string Username, string Passwort) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Passwort, int Original_ID, string Original_Username, string Original_Passwort) {
            if ((Username == null)) {
        ...
        public virtual int InsertQuery(string Username, string Passwort) {
            ...
            if ((Passwort == null)) {
                ...
                command.Parameters[1].Value = ((string)(Passwort));
            }
